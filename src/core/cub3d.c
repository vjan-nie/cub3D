...
/*   Updated: 2025/11/26 12:13:33 by vjan-nie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	mlx_loop_hook(cub.mlx, main_loop, &cub); //main_loop se asigna al loop de mlx_loop y establece qué hacer en cada vuelta
	mlx_loop(cub.mlx);
	return (0);
}
